...
- [Delegação e compartilhamento de receita](/pt/for-merchants/delegation-and-revenue-sharing)
- [Seguro](/pt/for-merchants/insurance)
- [Práticas de risco e confiabilidade](/pt/for-merchants/risk-and-reliability-practices)
- [Solução de problemas](/pt/for-merchants/troubleshooting)
- [Perguntas frequentes](/pt/for-merchants/faq)

Consulte também [`/for-users`](/pt/for-users/start-here) para entender as expectativas do lado do usuário e [`/whitepaper`](/pt/whitepaper/abstract) para contexto sobre o protocolo.
