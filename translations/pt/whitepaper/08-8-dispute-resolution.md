...
Ônus padrão: a parte que alega a conclusão fornece evidências da conclusão. O contestante pode apresentar contra-evidências (por exemplo, extrato bancário mostrando não recebimento). Caminhos de falha em provar acionam penalidades ou reembolsos de acordo com as regras do Protocolo.

## 8.2 Penalidade por Alegações Falsas

No caso de um comprador tentar prosseguir sem efetuar a transferência fiduciária, ele arrisca perder Pontos de Reputação, criando fortes desincentivos econômicos contra comportamentos fraudulentos.
